public static class PlayerParameters
{
    ...
    // ── Enemy detection – expressed in seconds at MEDIUM_LINEAR_SPEED ──
    public const float ENEMY_DETECTION_TIME  = 15f;   // 15 s → 150 u
    public const float ENEMY_LOSE_TIME       = 30f;   // 30 s → 300 u
    ...
    // ── Enemy attack ranges – expressed in seconds ────────
    public const float ENEMY_MELEE_TIME    = 2f;    // 2 s  → 20 u
    public const float ENEMY_RANGED_TIME   = 15f;   // 15 s → 150 u
