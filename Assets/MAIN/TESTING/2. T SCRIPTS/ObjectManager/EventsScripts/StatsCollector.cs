...
{
    [Header("References")]
    public DatabaseService databaseService;   // renombrado
    ...
    public void EndGame(bool victory)
    {
        ...
        databaseService?.SaveRun(run);

        // Mostrar UI final y pausar el juego
        if (endGameUI != null)
            endGameUI.Show(run, databaseService?.GetBestRun());
    }
}